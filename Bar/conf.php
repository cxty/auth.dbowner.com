...
$config['DB_HOST']					='192.168.0.198';//'127.0.0.1';//'192.168.1.254';					//数据库主机
$config['DB_USER']					='dbowner_auth_db';//'cxty';							//数据库用户名
$config['DB_PWD']					='f6a4bc162';//'1q2w3e';							//数据库密码
$config['DB_PORT']					=3306;							//数据库端口，mysql默认是3306
$config['DB_NAME']					='dbowner_auth_db';				//数据库名
...
$config['db_oauth']['host'] = 'https://auth.dbowner.com';

$config['DynamicJs']['goldurl'] = 'http://auth.dbowner.com';

// <meta property="qc:admins" content="1700603126642776526375" /> //QQ的meta