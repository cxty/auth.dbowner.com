...
//echo '<pre>';print_r($this->adapter);echo '</pre>';exit;
		return $this;
	}
	...
	*/
	function login()
	{
		...
		//unset(Hybrid_Auth::$config);
//echo '<pre>';print_r(Hybrid_Auth::$config);echo '</pre>';exit;
$HYBRID_AUTH_URL_BASE = 'http://localhost/include/ext/hybridauth';
		...
		//echo '<br>';echo $HYBRID_AUTH_URL_BASE;echo '<br>';
		...
		//echo $this->params["login_start"];exit;
		//$this->params["login_start"] = __ROOT__.'/index/joinfrom/?' . "hauth.start={$this->id}&hauth.time={$this->params["hauth_time"]}";
