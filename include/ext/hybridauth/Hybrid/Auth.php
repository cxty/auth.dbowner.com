...
//echo $providerId;echo '<pre>';print_r($params);echo '</pre>';exit;
	...
	*/
	...
	{
		//echo $providerId;exit;
		//echo (bool) Hybrid_Auth::storage()->get( "hauth_session.{$providerId}.is_logged_in" );echo 11;exit;
